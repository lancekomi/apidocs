    ...
    public class MaterialTabSelector : Control, IMaterialControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            foreach (TabPage tabPage in _baseTabControl.TabPages)
            {
                ...
                g.DrawString(tabPage.Text, SkinManager.ROBOTO_MEDIUM_10, textBrush, _tabRects[currentTabIndex], new StringFormat { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center });
                textBrush.Dispose();
            }
        ...
        private void UpdateTabRects()
        {
            ...
            using (var b = new Bitmap(1, 1))
            {
                ...
                {
                    _tabRects.Add(new Rectangle(0, 0, base.Width / 2, base.Height));
                    for (int i = 1; i < _baseTabControl.TabPages.Count; i++)
                    {
                        _tabRects.Add(new Rectangle(_tabRects[i - 1].Right, 0, base.Width / 2, base.Height));
                    }
                }
            }
        }
