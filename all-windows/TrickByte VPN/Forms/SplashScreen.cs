...
namespace SmartDNSProxy_VPN_Client
{
    public partial class SplashScreen : MaterialForm
    {
        ...
        {
            ProcessStartInfo getAcc = new ProcessStartInfo("https://www.getflix.com/signup");
        ...
        private void SplashScreen_Load(object sender, EventArgs e)
        {
            ...
            {
                MetroMessageBox.Show(this,"Getflix VPN Client is already running.", Application.ProductName,
        ...
        private void ShowMe()
        {
            ...
            TopMost = true;
            TopMost = false;
            MetroMessageBox.Show(this, "Getflix VPN Client VPN Client is already running");
        }
    }
}
