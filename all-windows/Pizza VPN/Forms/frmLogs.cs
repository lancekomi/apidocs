...
namespace SmartDNSProxy_VPN_Client
{
    public partial class frmLogs : MaterialForm
    {
        public frmLogs()
        {
            ...
            tabControlLog.UseCustomBackColor = false;
            tabControlLog.UseCustomForeColor = true;
            tabControlLog.UseStyleColors = true;
            tabControlLog.Style = MetroColorStyle.Orange;
        }
