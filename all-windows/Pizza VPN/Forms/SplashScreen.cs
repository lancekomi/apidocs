...
namespace SmartDNSProxy_VPN_Client
{
    public partial class SplashScreen : MaterialForm
    {
        ...
        {
            ProcessStartInfo getAcc = new ProcessStartInfo("https://pizzavpn.com/register");
        ...
        private void SplashScreen_Load(object sender, EventArgs e)
        {
            ...
            {
                MetroMessageBox.Show(this,"Pizza VPN Client is already running.", Application.ProductName,
        ...
        private void ShowMe()
        {
            ...
            TopMost = true;
            TopMost = false;
            MetroMessageBox.Show(this, "Pizza VPN Client VPN Client is already running");
        }
    }
}
