...
namespace SmartDNSProxy_VPN_Client
{
    ...
    {
        // Margins around owner drawn MetroComboBoxes.
        ...
        public static void DisplayImagesAndText(this ComboBox cbo, List<Country> values)
        {
            // Make the ComboBox owner-drawn.
            cbo.DrawMode = DrawMode.OwnerDrawVariable;
            ...
            cbo.Items.Clear();
            cbo.Items.AddRange(valuesArray);
        ...
        private static void cboDrawImageAndText_MeasureItem(object sender, MeasureItemEventArgs e)
        {
            ...
            // Get the item.
            ComboBox cbo = sender as ComboBox;
            Country item = (Country)cbo.Items[e.Index];
